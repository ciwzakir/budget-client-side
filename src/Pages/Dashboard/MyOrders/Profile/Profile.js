...
const Profile = () => {
  ...
  <div className="grid ">
  <div class="card card-compact w-96 bg-base-100 shadow-xl justify-center">
        <figure>
          <img
        ...
        <div class="card-body">
          ...
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla ratione labore officiis libero similique assumenda, officia repellendus quos sequi vel.</p>
