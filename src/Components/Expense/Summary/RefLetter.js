    ...
    <div className="my-24 p-7">
      <div className="card w-200 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p> Respected<span className="supplier-info px-2"> {item_supplier?.name} </span>  ,</p>

          <p className="pr-24"> We would like to inform you that we have issued a cheque bearing no  <span className="supplier-info">CDB ..................... </span> dated <span className="supplier-info"> .............. </span>  amounting Tk. <span className="supplier-info"> {total_paid} </span> &#40; One crore one lac one thousand one hindred one only &#41; for the supply of your products/ Goods. Asper govt. rules tk. <span className="supplier-info"> {total_tds} </span> as income Tax and Tk. <span className="supplier-info"> {total_vds} </span> as VAT has/ have been deducted from your total bill/ bills &#40;<span className="supplier-info"> {total_exp} </span> &#41; . Details of your invoice is/are as under. </p>
